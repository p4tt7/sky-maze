...
public class Position
{
    ...
    public static void Movement(Ficha ficha)
    {
        ...
        {
            if (ficha.Posicion.y > 0 && !IsWall(ficha, ficha.Posicion.x, ficha.Posicion.y - 1) && !IsFicha(ficha.Posicion.x - 1, ficha.Posicion.y))
            {
                ficha.Posicion.y -= 1;
                moverse = true;
            }
        ...
        {
            if (ficha.Posicion.y < Board.dimension - 1 && !IsWall(ficha, ficha.Posicion.x, ficha.Posicion.y + 1) && !IsFicha(ficha.Posicion.x - 1, ficha.Posicion.y))
            {
                ficha.Posicion.y += 1;
                moverse = true;
            }
